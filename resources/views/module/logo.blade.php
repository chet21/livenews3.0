<div class="container-fluid" style="max-height: 130px; border-bottom: 1px solid silver">
{{--    box-shadow: 0px -5px 10px -7px rgba(0,0,0,0.5);--}}
    <div class="container">
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-3 d-none d-xl-block d-lg-block d-md-block">
